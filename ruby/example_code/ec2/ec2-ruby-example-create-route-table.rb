...
#snippet-keyword:[create_route_table function]
#snippet-keyword:[Table.associate_with_subnet function]
#snippet-keyword:[Table.create_route function]
#snippet-keyword:[Table.create_tags function]
