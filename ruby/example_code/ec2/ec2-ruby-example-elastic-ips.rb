...
#snippet-keyword:[allocate_address function]
#snippet-keyword:[associate_address function]
#snippet-keyword:[describe_addresses function]
#snippet-keyword:[release_address function]
