...
#snippet-keyword:[create_access_key function]
#snippet-keyword:[delete_access_key function]
#snippet-keyword:[get_access_key_last_used function]
#snippet-keyword:[list_access_keys function]
#snippet-keyword:[update_access_key function]
